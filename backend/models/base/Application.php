...
abstract class Application extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['job_choice_1'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Job::className(), 'targetAttribute' => ['job_choice_1' => 'id']],
            [['job_choice_2'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Job::className(), 'targetAttribute' => ['job_choice_2' => 'id']],
            [['job_choice_3'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Job::className(), 'targetAttribute' => ['job_choice_3' => 'id']],
    ...
    {
        return $this->hasOne(\backend\models\Job::className(), ['id' => 'job_choice_1']);
    }
    ...
    {
        return $this->hasOne(\backend\models\Job::className(), ['id' => 'job_choice_2']);
    }
    ...
    {
        return $this->hasOne(\backend\models\Job::className(), ['id' => 'job_choice_3']);
    }
