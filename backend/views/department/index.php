 ...
 */
$this->title = Yii::t('models', 'Departments');
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Departments') ?>
        <small>
            List
        </small>
    </h1>
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				...
				[
					'url' => ['job/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Job'),
				],
