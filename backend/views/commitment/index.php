 ...
 * @var common\models\CommitmentSearch $searchModel
 */
$this->title = Yii::t('models', 'Commitments');
...
?>
<div class="giiant-crud commitment-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Commitments') ?>
        <small>
            List
        </small>
    </h1>
