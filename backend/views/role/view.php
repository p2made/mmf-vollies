...
$this->title = Yii::t('models', 'Role');
$this->params['breadcrumbs'][] = ['label' => Yii::t('models', 'Roles'), 'url' => ['index']];
...
<div class="giiant-crud role-view">
    ...
    <?php $this->beginBlock('common\models\Role'); ?>
		...
		'columns' => [
			[
				...
				'urlCreator' => function ($action, $model, $key, $index) {
					...
					$params['User'] = ['role_id' => $model->primaryKey()[0]];
					return $params;
				},
				'buttons'    => [
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['common\models\Role'],
				'active'  => true,
			],
			[
