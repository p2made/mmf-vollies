...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
	<strong>Note:</strong> According to the information I have you’re either a team leader &amp;/or a committee member. When submitting your application select “Special” (it’s the last item in the menu) in Job Choice 1, &amp; make no selection for the other job choices.
</p>
