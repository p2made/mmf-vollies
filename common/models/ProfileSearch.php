 ...
 *
 * Class \common\models\ProfileSearch
 */
class ProfileSearch extends Profile
{
	...
	public function rules()
	{
		return [
			...
			[['givenName', 'familyName', 'preferredName', 'phone1', 'phone2', 'address1', 'address2', 'locality', 'state', 'postcode', 'country', 'emergencyContact', 'emergencyPhone1', 'emergencyPhone2', 'discovery', 'discoveryDetail', 'dnr', 'timezone', 'full_name', 'created_at', 'updated_at'], 'safe'],
		];
	}
