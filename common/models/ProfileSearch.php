...
class ProfileSearch extends Profile
{
	...
	{
		return [
			[['id', 'user_id', 'rsa', 'dl_c', 'dl_h', 'cse', 'ohs', 'bc', 'vol', 'mmfVol', 'mmfAtt', 'returned', 'created_by', 'updated_by'], 'integer'],
			[['givenName', 'familyName', 'preferredName', 'phone1', 'phone2', 'address1', 'address2', 'locality', 'state', 'postcode', 'country', 'emergencyContact', 'emergencyPhone1', 'emergencyPhone2', 'dnr', 'discovery', 'discoveryDetail', 'email', 'timezone', 'full_name', 'created_at', 'updated_at'], 'safe'],
		];
	}
