...
class HistorySearch extends History
{
    ...
    {
        return [
            [['id', 'profile_id', 'rsa', 'dl_c', 'dl_h', 'cse', 'ohs', 'vol', 'mmfVol', 'mmfAtt', 'returned', 'id_orig', 'created_by', 'updated_by'], 'integer'],
            [['givenName', 'familyName', 'preferredName', 'email', 'phone1', 'phone2', 'address1', 'address2', 'locality', 'state', 'postcode', 'country', 'emergencyContact', 'emergencyPhone1', 'emergencyPhone2', 'preferredJobs', 'availability', 'commentsInfo', 'discovery', 'ip', 'key_orig', 'created_orig', 'updated_orig', 'created_at', 'updated_at'], 'safe'],
        ];
    }
