...
class HistorySearch extends History
{
    ...
    {
        return [
            [['id', 'user_id', 'rsa', 'dl_c', 'dl_h', 'cse', 'ohs', 'vol', 'mmfVol', 'mmfAtt', 'returned', 'created_by', 'updated_by', 'original_id'], 'integer'],
            [['givenName', 'familyName', 'preferredName', 'email', 'phone1', 'phone2', 'address1', 'address2', 'locality', 'state', 'postcode', 'country', 'emergencyContact', 'emergencyPhone1', 'emergencyPhone2', 'preferredJobs', 'availability', 'commentsInformation', 'discovery', 'created_at', 'updated_at', 'ip', 'key_orig', 'created_orig', 'updated_orig'], 'safe'],
        ];
    }
