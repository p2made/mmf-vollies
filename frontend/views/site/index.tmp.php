		...
		<div class="box">
			...
			<div class="col-md-8">
				<div class="alert alert-danger" role="alert">
					<p class="lead">The applications site has a problem at the moment. Please check back later or contact Pedro to be notified when it's when it's working again.</p>
				</div>
