...
/**
 * UserProfileController implements the CRUD actions for User & Profile models.
 */
class UserProfileController extends \amnah\yii2\user\controllers\DefaultController
{
	/**
	...
	public function actionProfile()
	{
		...
		if ($loadedPost && $profile->validate()) {
			...
			return $this->redirect(Url::to(['/application/create']));
			//return $this->refresh();
		}
